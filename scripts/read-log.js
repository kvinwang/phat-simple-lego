...
async function main() {
    ...
    const contractLogServer = loadContractFile(`${driverDir}/log_server.contract`);
    const contractSystem = loadContractFile(`${driverDir}/system.contract`);
    ...
    const clusterInfo = (await api.query.phalaPhatContracts.clusters(clusterId)).unwrap();
    ...
    const loggerId = loggerLookup.output.asOk.unwrap().toHex();
